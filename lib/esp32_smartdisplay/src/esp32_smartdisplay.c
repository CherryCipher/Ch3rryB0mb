...
void smartdisplay_init()
{
  ...
  //Here I introduced SMARTDISPLAY_DISABLE_TOUCH to convert the hardware SPI to a sotfware SPI using softtouch
  //this is to make sure the SD and touch controller can function at the same time as I was running into conflicts
// If there is a touch controller defined
#ifdef BOARD_HAS_TOUCH
#ifndef SMARTDISPLAY_DISABLE_TOUCH
  // Setup touch
